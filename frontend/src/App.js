...
import { Calendar, MapPin, Search, Users, Plus, Edit, Trash2, LogOut } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            {isAdmin ? (
              <>
                <Link to="/admin" className="text-gray-700 hover:text-blue-600 font-medium transition-colors" data-testid="nav-admin-dashboard">Dashboard</Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="border-2 hover:shadow-lg transition-shadow" data-testid="feature-register">
            ...
            <CardContent>
              <p className="text-gray-600">Register for events with just a few clicks. Simple and hassle-free process.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:shadow-lg transition-shadow" data-testid="feature-manage">
            ...
            <CardContent>
              <p className="text-gray-600">Admins can create, update, and track event registrations effortlessly.</p>
            </CardContent>
          </Card>
        </div>
      </div>
